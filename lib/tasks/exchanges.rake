namespace :exchanges do
  ...
  task charge_unreturned_items: :environment do
    ...
    unreturned_return_items.group_by(&:exchange_shipment).each do |shipment, return_items|
      item_charger = SolidusExpeditedExchanges::UnreturnedItemCharger.new(shipment, return_items)
    ...
    if failures.any?
      if SolidusExpeditedExchanges::UnreturnedItemCharger.failure_handler
        SolidusExpeditedExchanges::UnreturnedItemCharger.failure_handler.call(failures)
      else
